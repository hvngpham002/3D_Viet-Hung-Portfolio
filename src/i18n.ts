...
const resources = {
  ...
  vi: {
    translation: {
      ...
      "In 2024, I conquered my final quest before graduation at NVIDIA.":
        ...
        "Student Assistant": "Trợ giảng viên",
        "Technical & Marketing Intern": "Thực tập viên kỹ thuật & Marketing",
        "Systems Software Engineering Intern": "Thực tập viên kỹ thuật hệ thống phần mềm",
        "Freelance Web Developer": "Nhà phát triển web tự do",
        "NVIDIA": "NVIDIA",
        "Worcester Polytechnic Institute": "Trường Đại học bách khoa Worcester",
        "New England Clean Energy": "Công ty năng lượng sạch New England",
        "Minh Hung Investment & Development JSC": "Công ty đầu tư và phát triển Minh Hưng",
  ...
  zh: {
    translation: {
      ...
      "Skills": "技能",
      "Experiences": "经验",
      "Student Assistant": "学生助理",
      "Technical & Marketing Intern": "技术实习生",
      "Systems Software Engineering Intern": "系统软件工程实习生",
      "Freelance Web Developer": "自由职业者",
      "NVIDIA": "英伟达",
